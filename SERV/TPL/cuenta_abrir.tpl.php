...
$c = 'UPDATE ordenes SET flag_tiquetado=0, flag_pagado=0, flag_anulado=0, fechahora_pagado="0000-00-00 00:00:00", fechahora_anulado="0000-00-00 00:00:00" WHERE cuenta="'.$cuenta.'"';
db_consultar($c);
